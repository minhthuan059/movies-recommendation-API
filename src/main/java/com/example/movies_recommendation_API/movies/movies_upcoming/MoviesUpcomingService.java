package com.example.movies_recommendation_API.movies.movies_upcoming;
...
@Service
public class MoviesUpcomingService {
    ...
    public ResponseEntity<?> getAllMovies(
        ...
        query.with(Sort.by(direction, "release_date"));

        // Tổng số phần tử trong collection
        long totalElements = mongoTemplate.count(new Query(), "movies_upcoming");

        // Dữ liệu phân trang
        List<Map> movies = mongoTemplate.find(query, Map.class, "movies_upcoming");

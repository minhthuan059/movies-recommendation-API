package com.example.movies_recommendation_API.movies.movies_trending_week;
...
@Service
public class MoviesTrendingWeekService {
    ...
    public ResponseEntity<?> getAllMovies(
        ...
        long totalElements = mongoTemplate.count(new Query(), "movies_trending_week");

        // Dữ liệu phân trang
        List<Map> movies = mongoTemplate.find(query, Map.class, "movies_trending_week");
